...
### Added
- Initialized monetization project documentation.
- Added AI/Codex operating rules in `AGENTS.md`.
...
- Avoid mainstream English vocabulary as first app-store product.
